...
import { aggiornaMappa, aggiornaSpillo, creaMappa, creaSpillo, dettaglioMappa, elencaMappe, eliminaMappa, eliminaSpillo, esportaMappe, importaMappe, impostaImmagineMappa, mappaPerEntita, type DatiMappa, type DatiSpillo } from '../services/mappe/mappeService.js';
import { bodyAggiornaMappa, bodyAggiornaSpillo, bodyCreaMappa, bodyCreaSpillo, bodyImporta, paramsMappa, paramsSpillo, queryMappa } from '../schemas/mappe.js';
...
router.get('/esporta', (_req, res) => {
  res.setHeader('Content-Disposition', 'attachment; filename="mappe-p5r.json"');
  res.json(esportaMappe());
});
