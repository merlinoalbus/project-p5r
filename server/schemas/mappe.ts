...
export const bodyCreaMappa = z.object({
  chiave: chiaveMappa.optional(), nome: z.string().min(1).max(120), tipo: z.enum(TIPI_MAPPA), genitore: chiaveMappa.nullable().optional(), ordine: z.number().int().min(0).max(9999).optional(),
