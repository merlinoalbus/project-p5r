...
|---|---|---|
| 0.1 | Scaffold: config, BE (Express+SQLite, middleware, migrazioni, backup), FE tablet-first (layout, tema P5R), script server, Docker, CI/CD GHCR, docs di bordo | ⏳ |
| 0.2 | Dataset Royal: download dei sorgenti Apache-2.0 (chinhodado), normalizzazione in `data/seed/*.json`, verifica incrociata con aqiu384, `NOTICE` | ⬜ |
...
| 0.6 | Prompt per asset grafici in stile P5R con link di riferimento (`docs/grafica/prompt-immagini.md`) | ⬜ |
