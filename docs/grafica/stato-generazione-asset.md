...
**657 file richiesti: 521 completati e approvati, 136 ancora da consegnare.** La Fase 11.6 (§13) è completa e validata 37/37.
...
| palazzi | 10 | 10 | 0 |
| personaggi | 5 | 0 | 5 |
| ui (schede Partita e Fusione, §16) | 18 | 0 | 18 |
...
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-registra.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-indietro.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-carica.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-url.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-chiudi.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-attiva.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-mappa.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-ingrandisci.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-riduci.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-adatta.png` — 128×128 (§17)
- [ ] **DA CONSEGNARE** — `public/asset/ui/azione-calendario.png` — 128×128 (§17)
