...
## Statistiche — persona-it.json (59 voci nel censimento grezzo, 58 integrate)

232/232 Persona del compendio risolte (100%), di cui 58 con nome italiano effettivamente diverso dall'inglese (es. *Regent*→Reggente, *Queen's Necklace*→Collana della Regina, *Crystal Skull*→Teschio di Cristallo, *Bugs*→Babau, *Thunderbird*→Wakinyan, *Dionysus*→Dioniso, *Beelzebub*→Belzebù, *Cerberus*→Cerbero, *Mandrake*→Mandragora). Le rimanenti 174 hanno nome invariato in italiano.
