...
| 2026-09-03 | Porte dev 5273 (FE) / 3101 (BE); host Docker: SOLO 13820 (FE); BE non esposto, proxato da nginx su `/api/` | convivenza con project-jira (5173/3001, 13810/13811) e manhua; il FE è il target del tunnel Cloudflare gestito dall'utente | U/IA |
