...
| Visore delle mappe, elenco con molte voci | l'elenco cresceva senza limite: `max-height` e scorrimento c'erano **solo** sotto i 768 px. Un gruppo può avere molte voci — sul Corridoio del Crepuscolo, alla vista d'insieme, arriva a 17, cioè 858 px chiesti — e allora non ci sta né sopra né sotto, e la tela taglia le ultime voci **e** «Ingrandisci qui». 17 mappe su 206 hanno un gruppo con più di 5 voci | fino a 858 px in una tela da 500 | l'altezza è **legata alla tela**: si sceglie il lato con più spazio e le voci scorrono dentro quello che c'è, con intestazione e «Ingrandisci qui» sempre fuori dall'area che scorre. La stima delle voci serve solo a preferire il lato consueto quando l'elenco ci sta tutto |
