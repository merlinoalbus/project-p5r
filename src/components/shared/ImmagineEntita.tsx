  ...
  return (
    <>
      <button
        ...
        className={`immagine-entita bg-bg-tertiary border border-border flex items-center justify-center shrink-0 p-0 cursor-zoom-in hover:border-primary transition-colors ${className ?? ''}`}
