...
export const SEZIONI_GUIDA: SezioneGuida[] = [
  ...
  { chiave: 'inventari', to: '/guida/inventari', titolo: 'Inventari per categoria', descrizione: 'Armi, protezioni, accessori, abiti, regali, consumabili e materiali con ricerca e collegamento ai negozi', icona: <IconBook size={DIM} /> },
