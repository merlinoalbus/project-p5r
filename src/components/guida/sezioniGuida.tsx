...
export const SEZIONI_GUIDA: SezioneGuida[] = [
  ...
  { chiave: 'negozi', to: '/guida/negozi', titolo: 'Negozi', descrizione: '60 negozi e 575 articoli: catalogo completo, prezzi, disponibilità e acquisti per partita', icona: <IconBolt size={DIM} /> },
  { chiave: 'libri', to: '/guida/libri', titolo: 'Libri', descrizione: '46 libri con provenienza, benefici e avanzamento per sessioni; bonus e luoghi si sbloccano solo al completamento', icona: <IconBook size={DIM} /> },
  { chiave: 'attivita', to: '/guida/attivita', titolo: 'Attività e Doti sociali', descrizione: 'Mini-giochi, lavori, studio e film con le note delle Doti e il tracciamento per partita', icona: <IconStar size={DIM} /> },
