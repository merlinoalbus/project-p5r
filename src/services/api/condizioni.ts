...
export interface ElenchiRegole { stati:FattoGioco[]; articoli:Array<{chiave:string;nome:string;gruppo:string}>; letture:Array<{chiave:string;nome:string;categoria:'libro'|'film'}>; arcani:Array<{chiave:string;nome:string}>; persone:Array<{chiave:string;nome:string}>; abilita:Array<{chiave:string;nome:string}>; squadra:Array<{chiave:string;nome:string}> }
