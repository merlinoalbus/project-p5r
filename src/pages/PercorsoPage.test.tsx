...
vi.mock('../services/api', () => ({ getAgenda: vi.fn().mockResolvedValue({ giorno: '04-12', eventi: [], azioni: [] }), getPercorsoIndice, getPercorsoGiorno, impostaAzionePercorso, impostaGiornoCorrente, impostaFasciaGioco: vi.fn(), getImmagini: vi.fn().mockResolvedValue([]), caricaImmagine: vi.fn(), eliminaImmagine: vi.fn(), importaImmagineDaUrl: vi.fn(), urlImmagine: (ambito: string, chiave: string) => `/api/immagini/${ambito}/${chiave}/file` }));
