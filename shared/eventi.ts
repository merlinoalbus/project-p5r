...
export const ETICHETTE_EVENTO: Readonly<Record<TipoEvento, { nome: string; gruppo: 'partita' | 'doti' | 'confidenti' | 'persona' | 'velluto' | 'obiettivi' | 'dungeon' }>> = {
  ...
  'timbri-dedalo': { nome: 'Timbri di un dedalo tutti raccolti', gruppo: 'dungeon' },
  ...
  trofeo: { nome: 'Trofeo ottenuto', gruppo: 'partita' },
  denaro: { nome: 'Denaro del gruppo', gruppo: 'partita' },
  squadra: { nome: 'Livello di un Ladro', gruppo: 'partita' },
