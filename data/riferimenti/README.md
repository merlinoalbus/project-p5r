...
- Contenuto attuale: 24 Arcani (tutti, compreso Fede), 23 Confidenti (icone stile carta), 231 Persona (`mancanti.persona` elenca chi non ha riferimento). Censimento e voci incerte in `docs/riferimenti/catalogo-immagini-wiki.md`.
