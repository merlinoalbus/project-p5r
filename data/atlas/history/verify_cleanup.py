...
r=json.loads(Path('work/cleanup-prova-report.json').read_text(encoding='utf-8'));p=json.loads(Path('outputs/mappe-p5r/app-integration/piano-pulizia-globale.json').read_text(encoding='utf-8'))
