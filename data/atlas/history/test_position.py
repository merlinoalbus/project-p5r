...
p=r/'server/routes/posizioni-spilli.test.ts'
p.write_text('''import request from 'supertest';
...
it('mantiene condizioni bloccanti senza dichiarare disponibile una semplice posizione',async()=>{
 ...
 const s=(await crea({soloPosizione:true,condizioni:[{tipo:'data',dal:'12-01'}]})).body.data;
...
''',encoding='utf-8')
p=r/'src/components/mappe/NavigazioneSpillo.test.tsx'
